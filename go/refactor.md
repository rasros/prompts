...
- If the input is a skeleton (types and function signatures without bodies), treat it as the structural contract. Refactor the signatures only and do not invent function bodies unless the goal explicitly asks for them.
