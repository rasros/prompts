...
- If the input is a skeleton (classes, interfaces, and function signatures without bodies), assume the bodies do not yet exist; the plan should describe how to fill them.
- Prefer reusing existing classes, functions, and modules visible in the provided code.
