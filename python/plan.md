...
- If the input is a skeleton (classes and function signatures without bodies), assume the bodies do not yet exist; the plan should describe how to fill them.
